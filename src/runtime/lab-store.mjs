...
function normalizeAdapterMetadata(value, field, corruptOnFailure = false) {
  ...
  if (value.transport !== undefined && !['persistent-jsonl', 'tls-jsonl', 'persistent-tls-jsonl'].includes(value.transport)) {
...
function isValidWitnessMetadata(value) {
  return value !== null && typeof value === 'object' && !Array.isArray(value) &&
    ...
    typeof value.descriptorDigest === 'string' && /^sha256:[0-9a-f]{64}$/u.test(value.descriptorDigest) &&
    typeof value.launchDigest === 'string' && /^sha256:[0-9a-f]{64}$/u.test(value.launchDigest) &&
    (value.transport === undefined || value.transport === 'persistent-jsonl' || value.transport === 'tls-jsonl' || value.transport === 'persistent-tls-jsonl');
}
